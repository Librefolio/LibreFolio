...
- Holdings tables on the Dashboard and Broker pages now show transaction-ledger **Yield on Cost** by asset and broker. The metric uses gross recorded dividend and interest income, D-1 eligible quantity, linked splits, portfolio FX rates and residual average unit cost; unavailable values explain the exact missing or inconsistent input.
