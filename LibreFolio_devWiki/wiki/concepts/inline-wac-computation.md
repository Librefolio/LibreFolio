...
| WAC utilities (pure math) | `backend/app/utils/financial/wac_utils.py` |
| vNext unit tests (20 tests) | `backend/test_scripts/test_services/test_portfolio_engine_vnext.py` |
