...
> ## 📦 CARTELLA ARCHIVIATA — 16 Settembre 2026
>
> Questo è il materiale della **prima campagna Risk** (Luglio 2026), conservato come
> archivio storico. **Non è più la fonte di pianificazione corrente.**
>
> **Resta valido e citabile** per: contratto matematico, architettura dei worker,
> evidenze di benchmark, versioni delle librerie, oracle di simulazione.
>
> **È superato** per: la catena G6 e la sua sequenza di viste, la gerarchia di priorità
> fra le metriche, l'information architecture a quattro tab di Assets Global.
>
> La pianificazione corrente parte da [`../README.md`](../README.md).
