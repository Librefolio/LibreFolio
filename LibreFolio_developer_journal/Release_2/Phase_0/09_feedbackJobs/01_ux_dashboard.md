...
| U3 | ✅ [IMPLEMENTATO, VERIFICATO, DEVELOPER-ACCEPTED E INTEGRATO](../19_yieldOnCost/plan-phase00YieldOnCost.prompt.md), checkpoint H `74afcebce`. | SP06 |
...
| U8 | 🟡 [Checkpoint J Round 2 revisionato](../21_onboarding/plan-phase00OnboardingRound2-ModularGuides.prompt.md); [Round 3](../21_onboarding/plan-phase00OnboardingRound3-TriggeredTours.prompt.md) pianificato soltanto, senza implementazione. | SP11 |
