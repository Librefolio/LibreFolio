...
| Onboarding | Checkpoint Round 2 revisionato: Welcome, Core versionato e guide contestuali Broker/FX/Asset/Import; Round 3 granularizza pagina/Add/dettaglio ma resta pianificato soltanto. |
...
| **SP11 - Benvenuto e tour** | U8 | ✅ [Implementato da J](../21_onboarding/plan-phase00Onboarding.prompt.md): stato/migrazione -> welcome -> tour breve -> guida import -> replay/skip. Gate automatici completi; review manuale developer ancora pendente. | Nuovo utente guidato senza scritture finanziarie automatiche; default admin rispettati; skip/replay/refresh/account e overlay compatibili, guide riallineate. |
...
| G-ONBOARDING | Chiudere U8 | ✅ Stato/versione, utenti esistenti, errori, resume, skip e replay verificati automaticamente nel [piano J](../21_onboarding/plan-phase00Onboarding.prompt.md). Resta il walkthrough manuale desktop/mobile prima della chiusura. |
