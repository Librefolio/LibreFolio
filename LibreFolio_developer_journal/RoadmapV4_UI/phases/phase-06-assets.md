...
| **2c** | [**Rientro 2**](../plan-phase06Step2cSyncDeleteRefactor.prompt.md): fix chart refresh, stopPropagation azioni tabella, rimuovere edit ridondante + sync/refresh, bulk actions multi-select, blocco 2×2 Assets, fix colonne Δ visibilità | 1g | ✅ |
