...
class FAAssetEventPointOut(FAAssetEventPoint):
    ...
    original_value: Optional[Currency] = Field(None,description="Value before FX conversion (amount + currency). Populated iff target_currency conversion applied (E.8).",)
    fx_info: Optional[FxBackwardFillInfo] = Field(None,description="FX staleness for the conversion (fx_rate_date + fx_days_back). Populated iff target_currency conversion applied (E.8).",)
