"""Exact evaluator for the PAC/Rebalancer planner v2.

Every quantity here is computed on ``ExactRatio``, never on floats: the planner
...
budgets and target gaps, never released, superseded by the exact domain below.
"""
