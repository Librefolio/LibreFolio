...
Covers:
- BRSummary: currencies
- BaseBulkResponse: total_count
...
from backend.app.schemas.common import BaseBulkResponse, Currency
from backend.app.schemas.fx import FXUpsertResult
...
class TestBRSummaryComputed:
    """Test BRSummary computed properties (currencies)."""
