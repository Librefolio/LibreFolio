...
type FAAssetEventPointOut = {
  ...
  notes?:
    ...
    | undefined;
  /**
   * Event DB primary key
   */
  id: number;
  /**
   * True if generated by provider (provider_assignment_id IS NOT NULL)
   */
  is_auto: boolean;
};
...
type FABulkEventUpsertResponse = {
  /**
   * Per-item operation results
   */
  results: Array<FAEventUpsertResult>;
  /**
   * Number of successful operations
   *
   * @minimum 0
...
type FAEventQueryResponse = Partial<{
  /**
   * List of items
   */
  items: Array<FAEventQueryResult>;
}>;
type FAEventQueryResult = {
  /**
   * Asset ID queried
   */
  asset_id: number;
  events?: /**
   * Asset events with id and is_auto
   */
  Array<FAAssetEventPointOut> | undefined;
};
type FAEventUpsert = {
  /**
   * Asset ID
   ...
   */
  events: Array<FAAssetEventPoint_Input>;
};
...
const FAAssetEventPoint_Input: z.ZodType<FAAssetEventPoint_Input> = z.object({
  date: z.string().describe("Event date"),
  type: z
    .string()
    .describe("Event type (DIVIDEND, INTEREST, PRICE_ADJUSTMENT, SPLIT)"),
...
const FAEventUpsert: z.ZodType<FAEventUpsert> = z.object({
  asset_id: z.number().int().describe("Asset ID"),
  events: z
    .array(FAAssetEventPoint_Input)
    .min(1)
    .describe("List of event points"),
});
const FAEventUpsertResult: z.ZodType<FAEventUpsertResult> = z.object({
  asset_id: z.number().int(),
  count: z.number().int(),
  message: z.string(),
});
const FABulkEventUpsertResponse: z.ZodType<FABulkEventUpsertResponse> =
  z.object({
    results: z
      .array(FAEventUpsertResult)
      .describe("Per-item operation results"),
    success_count: z
      .number()
      .int()
...
const FAEventDeleteResult = z.object({
  success: z.boolean().describe("Whether the deletion succeeded"),
  deleted_count: z.number().int().gte(0).describe("Number of items deleted"),
  message: z
    .union([z.string(), z.null()])
    .describe("Info/warning/error message")
    .optional(),
  event_id: z.number().int().describe("ID of the event that was deleted"),
});
const FAEventQueryItem: z.ZodType<FAEventQueryItem> = z.object({
  asset_id: z.number().int().describe("Asset ID to query"),
  date_range:
    DateRangeModel.describe(`Reusable date range model for FA and FX operations.
...
const FAAssetEventPointOut: z.ZodType<FAAssetEventPointOut> = z.object({
  date: z.string().describe("Event date"),
  type: z
    .string()
    .describe("Event type (DIVIDEND, INTEREST, PRICE_ADJUSTMENT, SPLIT)"),
...
Raises:
    ValueError: If currency code is not valid ISO 4217 or supported crypto`),
  notes: z.union([z.string(), z.null()]).describe("Optional notes").optional(),
  id: z.number().int().describe("Event DB primary key"),
  is_auto: z
    .boolean()
    .describe(
      "True if generated by provider (provider_assignment_id IS NOT NULL)"
...
const FAEventQueryResult: z.ZodType<FAEventQueryResult> = z.object({
  asset_id: z.number().int().describe("Asset ID queried"),
  events: z
    .array(FAAssetEventPointOut)
    .describe("Asset events with id and is_auto")
    .optional(),
});
const FAEventQueryResponse: z.ZodType<FAEventQueryResponse> = z
  .object({ items: z.array(FAEventQueryResult).describe("List of items") })
  .partial();
...
- &#x60;identifier_type&#x60;: Type of identifier (TICKER, ISIN, UUID, OTHER)`,
  ...
  {
    method: "post",
    path: "/api/v1/assets/events",
    alias: "upsert_events_bulk_api_v1_assets_events_post",
    description: `Bulk upsert manual events (provider_assignment_id &#x3D; NULL).
...
are NOT affected — dedup is scoped by provider_assignment_id.`,
    ...
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: z.array(FAEventUpsert),
      },
    ],
    response: FABulkEventUpsertResponse,
    errors: [
      {
        status: 422,
        description: `Validation Error`,
  ...
  {
    method: "delete",
    path: "/api/v1/assets/events/:event_id",
    alias: "delete_event_api_v1_assets_events__event_id__delete",
    description: `Delete a single event by its primary key.
...
Auto events will be recreated on next provider sync.`,
  ...
  {
    method: "post",
    path: "/api/v1/assets/events/query",
    alias: "query_events_bulk_api_v1_assets_events_query_post",
    description: `Bulk query events for multiple assets.
    ...
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: z.array(FAEventQueryItem),
      },
    ],
    response: FAEventQueryResponse,
    errors: [
      {
        status: 422,
        description: `Validation Error`,
