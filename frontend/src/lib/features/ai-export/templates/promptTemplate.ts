...
export const PROMPT_WEB_RESEARCH = `If you have web access, research the assets, sectors, or themes that appear most relevant, concentrated, volatile, or technically notable.
...
4. Provide neutral monthly PAC allocation scenarios with rationale.
5. Use technical context only as supporting evidence, not as primary drivers.
6. Highlight any data quality limitations that affect your analysis.
