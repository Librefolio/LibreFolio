...
import type {OnboardingApi, OnboardingFlow, OnboardingProgressItem, OnboardingProgressResponse, OnboardingTransitionRequest} from '$lib/types/onboarding';

const progressItemSchema = z
    .object({
        flow: z.enum(['welcome', 'intro_tour', 'import_guide']),
