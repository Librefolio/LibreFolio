...
> 🎯 **Related**: [Financial Calculations](../../features/scheduled-investments.md) | [Database Schema](../architecture/database.md)
...
- **[Financial Calculations](../../features/scheduled-investments.md)** - Math functions being tested
- **[Database Schema](../architecture/database.md)** - DB structure
- **[API Development Guide](./api-development.md)** - API testing context

---

**Last Updated**: November 17, 2025

## 🕵️ How to get information about the testing framework

To get information about the testing framework an Agent can:

1.  Read this file and the other guides in this section (`testing/`).
2.  Inspect the `test_runner.py` script to understand the test categories and commands.
3.  Explore the `backend/test_scripts/` directory to see the individual test files.
4.  Run tests to see the output and understand the validation process.
