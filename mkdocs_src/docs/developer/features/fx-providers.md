...
- **[Provider Development Guide](../contributing/new-fx-provider.md)** - How to add new providers
- **[Architecture](../architecture/overview.md)** - System architecture
- **[API Reference](../../api/index.md)** - REST API endpoints

---
## 🕵️ How to get information about the available FX providers

To get information about the available FX providers an Agent can:

1.  Read this file.
2.  Inspect the directory `backend/app/services/fx_providers/` to see the implementation of each provider.
3.  Run the external tests for the FX providers to see them in action: `./test_runner.py external fx-providers`
4.  Call the `GET /api/v1/fx/providers` endpoint to get a list of registered providers.
