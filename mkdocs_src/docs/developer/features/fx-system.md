...
> 🎯 **Quick Start**: [API Reference](../../api/index.md) | [Available Providers](./fx/providers.md) | [Add New Provider](../contributing/new-fx-provider.md)
...
📖 **[Go to API Reference →](../../api/index.md)**
...
- **[API Reference](../api/index.md)** - REST endpoints, examples, best practices
- **[Available Providers](./fx-providers.md)** - ECB, FED, BOE, SNB details

### 🔧 Technical

- **[Architecture](../architecture/overview.md)** - System design, data flow, components
- **[Provider Development](../contributing/new-fx-provider.md)** - How to add new providers

### 🧪 Testing

- **[Testing Guide](../backend/testing.md)** - How to run FX tests
- **[Async Architecture](../architecture/async.md)** - Understanding async patterns
...
📖 **[Full Schema Documentation →](../architecture/database.md)**
...
📖 **[Full Configuration Guide →](../../getting-started/installation.md)**
...
**Solution:** Current providers are single-base. Check [Architecture](../architecture/backend.md)
...
**Solution:** Use SNB provider for correct multi-unit handling. See [Providers](./fx/providers.md)

📖 **[More troubleshooting →](../architecture/backend.md)**
...
curl -X DELETE ".../rate-set/bulk" -d '{
  "deletions": [{"from": "EUR", "to": "USD", "start_date": "2025-01-15"}]
}'

# Delete range
curl -X DELETE ".../rate-set/bulk" -d '{
  "deletions": [{"from": "EUR", "to": "USD", "start_date": "2025-01-01", "end_date": "2025-01-31"}]
}'
```
...
📘 **[Provider Development Guide →](../contributing/new-fx-provider.md)**
...
- **[API Reference](../../api/index.md)** - Complete REST API docs
- **[Providers](./fx-providers.md)** - ECB, FED, BOE, SNB details
- **[Provider Development](../contributing/new-fx-provider.md)** - Add new providers

### General Documentation
- **[Testing Guide](../backend/testing.md)** - How to run and write tests
- **[Async Architecture](../architecture/async.md)** - Understanding async patterns
- **[Database Schema](../architecture/database.md)** - Full database documentation
- **[API Development Guide](../backend/api-development.md)** - How endpoints are built
- **[Environment Variables](../../getting-started/installation.md)** - Configuration options

---
## 🕵️ How to get information about the FX system

To get information about the FX system an Agent can:

1.  Read this file and the other guides in this section.
2.  Inspect the `backend/app/services/fx.py` file for the core logic.
3.  Inspect the `backend/app/services/fx_providers/` directory for provider implementations.
4.  Run the FX tests to see the system in action:
    - `./test_runner.py services fx`
    - `./test_runner.py db fx-rates`
    - `./test_runner.py api fx`
    - `./test_runner.py external all`
