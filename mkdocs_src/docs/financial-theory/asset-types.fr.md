...
LibreFolio prend en charge un large éventail de classes d'actifs pour couvrir un portefeuille diversifié. Chaque type d'actif présente des comportements spécifiques concernant les prix, les dividendes et le traitement fiscal.
...
<table>
 ...
 <td style="white-space: nowrap;"><strong>Actions</strong></td>
 <td style="white-space: nowrap;"><code>STOCK</code></td>
 <td>Parts d'une société. Les cours sont généralement récupérés des bourses publiques.</td>
 </tr>
 <tr>
 ...
 <td>Fonds négociés en bourse. Paniers de titres qui s'échangent comme des actions.</td>
 </tr>
 <tr>
 ...
 <td>Monnaies numériques et tokens (Bitcoin, Ethereum, etc.).</td>
 </tr>
 <tr>
 <td style="text-align: center;"><img src="../../static/icons/asset-types/bond.png" width="32" /></td>
 <td style="white-space: nowrap;"><strong>Obligations</strong></td>
 <td style="white-space: nowrap;"><code>BOND</code></td>
 <td>Titres de créance représentant un prêt à un emprunteur (État ou entreprise).</td>
 </tr>
 <tr>
 <td style="text-align: center;"><img src="../../static/icons/asset-types/crowdfunding.png" width="32" /></td>
 <td style="white-space: nowrap;"><strong>P2P / Financement participatif</strong></td>
 <td style="white-space: nowrap;"><code>CROWDFUNDING</code></td>
 <td>Prêts pair-à-pair ou financement participatif immobilier. Souvent valorisés via des versements d'intérêts périodiques.</td>
 </tr>
 <tr>
 <td style="text-align: center;"><img src="../../static/icons/asset-types/fund.png" width="32" /></td>
 <td style="white-space: nowrap;"><strong>Fonds d'investissement</strong></td>
 ...
 <td style="white-space: nowrap;"><strong>Actifs physiques</strong></td>
 <td style="white-space: nowrap;"><code>HOLD</code></td>
 <td>Biens tangibles comme l'Or, l'Argent ou les Diamants, détenus pour leur valeur à long terme.</td>
 </tr>
 <tr>
 ...
 <td>Toute autre classe d'actifs (par ex. Or, Art, Capital-investissement).</td>
 </tr>
 </tbody>
</table>
