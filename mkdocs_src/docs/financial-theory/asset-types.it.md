...
LibreFolio supporta un'ampia gamma di classi di asset per coprire un portafoglio diversificato. Ogni tipo di asset presenta comportamenti specifici riguardanti la determinazione del prezzo, i dividendi e il trattamento fiscale.
...
<table>
 ...
 <td>Azioni di una società. I prezzi vengono tipicamente reperiti dalle borse pubbliche.</td>
 </tr>
 <tr>
 ...
 <td>Exchange Traded Funds. Panieri di titoli che negoziano come le azioni.</td>
 </tr>
 <tr>
 ...
 <td>Valute digitali e token, come Bitcoin, Ethereum, ecc.</td>
 </tr>
 <tr>
 ...
 <td>Titoli di debito che rappresentano un prestito a un emittente (governativo o societario).</td>
 </tr>
 <tr>
 ...
 <td>Prestiti peer-to-peer o crowdfunding nel settore immobiliare. Spesso valutati tramite pagamenti di interessi programmati.</td>
 </tr>
 <tr>
 ...
 <td style="white-space: nowrap;"><strong>Materie Prime</strong></td>
 <td style="white-space: nowrap;"><code>HOLD</code></td>
 <td>Beni materiali come oro, argento o diamanti dettenuti per valore a lungo termine.</td>
 </tr>
 <tr>
 ...
 <td>Qualsiasi altra classe di asset (es. oro, arte, private equity).</td>
 </tr>
 </tbody>
</table>
