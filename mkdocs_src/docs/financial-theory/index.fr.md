...
Cette section documente les modèles, conventions et définitions financières utilisés dans tout LibreFolio.

## 📖 Aperçu

Des calculs financiers précis sont critiques pour le suivi de portefeuille. LibreFolio met en œuvre des conventions financières standard pour assurer la cohérence avec les rapports des courtiers et les données réelles. Cette section couvre les concepts fondamentaux, des types d'actifs aux formules utilisées pour l'analyse de performance.
