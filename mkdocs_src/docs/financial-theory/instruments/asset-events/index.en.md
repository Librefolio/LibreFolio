...
Asset events represent **corporate actions or scheduled financial occurrences** that affect an asset globally — independent of any individual investor's portfolio. They are distinct from [transactions](../transaction-types/index.md), which track what happens at the portfolio level (e.g., a user buying or selling shares).
...
|------|-------|----------------|----------------|---------|
| **Dividend** | 💰 | Price drops by dividend amount (ex-date) | Stocks, ETFs | [📖](dividend.md) |
| **Interest** | 📈 | Accrual reduces remaining yield | Bonds, Loans, Fixed-income | [📖](interest.md) |
| **Split** | ✂️ | Price divides, quantity multiplies | Stocks, ETFs | [📖](split.md) |
| **Price Adjustment** | 📊 | Algebraic change (+/−) to fair value | Bonds, Illiquid assets | [📖](price-adjustment.md) |
| **Maturity Settlement** | 🏁 | Final capital return, no further pricing | Bonds, Term deposits | [📖](maturity-settlement.md) |
...
- 💸 **[Transaction Types](../transaction-types/index.md)** — Portfolio-level operations
