...
LibreFolio admite una amplia gama de clases de activos para cubrir una cartera diversificada. Cada tipo de activo tiene comportamientos específicos en cuanto a precios, dividendos y gestión fiscal.

## 📋 Activos admitidos

| | Type | Code | Description | |
|:---:|:---|:---|---|:---:|
| ![](../../../static/icons/asset-types/stock.png){: width="32" } | **Stock** | `STOCK` | Acciones de una empresa. Los precios se obtienen normalmente de bolsas públicas. | [📖](stocks.md) |
...
| ![](../../../static/icons/asset-types/other.png){: width="32" } | **Índice y Benchmark** | `—` | Índices de mercado (S&amp;P 500, MSCI World) utilizados como benchmarks — no negociables directamente. | [📖](index-benchmark.md) |

---

## 🔗 Relacionado

- 💸 **[Tipos de Transacción](../transaction-types/index.md)** — Operaciones que afectan a la cartera
- 📅 **[Eventos de Activos](../asset-events/index.md)** — Acciones corporativas que afectan los precios de los activos
- 💰 **[Tributación](../../fundamentals/taxation.md)** — Implicaciones fiscales por clase de activo
