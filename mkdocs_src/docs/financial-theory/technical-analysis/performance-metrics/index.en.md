...
|------------------|-------------|
| **[Net Asset Value (NAV)](nav.md)** | Net Worth / Net Asset Value. The total market valuation of the portfolio (assets + cash) at the end of the time window. |
| **[Book Value](book-value.md)** | The historical accounting cost of open positions plus cash. Used to compare purchase cost against market value. |
| **[Period P&L](period-pnl.md)** | The cash-flow adjusted absolute monetary profit or loss generated by your portfolio in the selected window. |
| **[Deposited Capital & Total P&L](deposited-capital.md)** | Net external capital contributed since inception; the anchor for computing Total P&L and the cash decomposition algorithm. |
| **[Timing Effect](timing-effect.md)** | Difference between Cumulative MWRR and Cumulative TWRR. Shows how much the timing and size of your cash flows impacted your overall return. |
