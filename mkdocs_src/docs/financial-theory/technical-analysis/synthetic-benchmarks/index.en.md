...
| Benchmark | Model | Shape on Linear Scale | Details |
|-----------|-------|----------------------|---------|
| **Linear Growth** | Simple interest | Straight line | [📖](linear.md) |
| **Compound Growth** | Compound interest | Exponential curve | [📖](compound.md) |
| **Sine Wave** | Periodic oscillation | Sinusoidal wave | [📖](sine-wave.md) |
