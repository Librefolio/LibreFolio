...
Esplora l'interfaccia desktop completa di LibreFolio. Gli screenshot si adattano automaticamente al tema e alla lingua selezionati.
...
Registra qualsiasi operazione — acquisto, vendita, dividendo, deposito, trasferimento, conversione FX — con ricerca degli asset e gestione automatica del segno. Il modulo si adatta al tipo selezionato.
...
<div class="screenshot-container">
 <img class="gallery-img" data-category="transactions" data-name="picker-modal" alt="Modale Transaction Picker">
</div>

### ✂️ Conferma Split

Quando si collegano transazioni con quantità non corrispondenti, il sistema propone un frazionamento — permettendo di anticipare il risultato prima di confermare.
...
<div class="screenshot-container">
 <img class="gallery-img" data-category="transactions" data-name="promote-merge-modal" alt="Modale Promote Merge">
</div>
...
Importa le transazioni dai file di esportazione del tuo broker — tramite il modulo rapido o la procedura guidata completa passo dopo passo.
...
<div class="lf-screenshot-carousel" data-carousel="carousel-desktop-2" data-carousel-interval="6000" data-show-titles="true" style="margin: 1rem 0 2rem 0;">
 <img class="gallery-img lf-screenshot-carousel-item is-active" data-category="brokers" data-name="import-modal" data-title="📥 Modale importazione rapida" alt="Modale Importazione">
 <img class="gallery-img lf-screenshot-carousel-item" loading="lazy" data-category="brokers" data-name="import-wizard-step1" data-title="🧙 Wizard — Passaggio 1: Caricamento" alt="Import Wizard Passaggio 1">
 <img class="gallery-img lf-screenshot-carousel-item" loading="lazy" data-category="brokers" data-name="import-wizard-step2" data-title="⚙️ Wizard — Passaggio 2: Configurazione Parser" alt="Import Wizard Passaggio 2">
 <img class="gallery-img lf-screenshot-carousel-item" loading="lazy" data-category="brokers" data-name="import-wizard-step4-resolution" data-title="🔍 Wizard — Passaggio 4: Risoluzione Asset" alt="Import Wizard Risoluzione Asset">
...
Personalizza lingua, valuta e tema secondo le tue preferenze.
...
Configura il daemon di sincronizzazione automatica dei dati di mercato: frequenza di aggiornamento, tempi di sincronizzazione dello storico e giorni attivi.
...
Visualizza lo storico delle esecuzioni dello scheduler, con durata, stato e dettagli per singolo asset.
...
Cambia la tua password in modo sicuro con validazione della forza.
...
<div class="screenshot-container">
 <img class="gallery-img" data-category="media" data-name="asset-picker-modal" alt="Modale Asset Picker">
</div>

### 📤 Caricatore File

Trascina e rilascia (drag-and-drop) o sfoglia per caricare i file. Le immagini aprono l'editor di ritaglio, gli altri file possono essere rinominati.
...
Gestisci la co-proprietà e i ruoli di accesso con un grafico a semicerchio che mostra la distribuzione della proprietà.
...
Tutti i tuoi strumenti finanziari monitorati — azioni, ETF, obbligazioni, crypto — in un'unica vista.
...
Grafico dei prezzi interattivo a dimensione intera con selettore di intervallo di date e interruttore della valuta. Passa dalla vista a linee a quella a candele.
...
Indicatori tecnici (EMA, RSI, MACD, Bollinger) sovrapposti al grafico dei prezzi — ciascuno in un pannello secondario dedicato.
...
<div class="lf-screenshot-carousel" data-carousel="carousel-desktop-7" data-carousel-interval="6000" data-show-titles="true" style="margin: 1rem 0 2rem 0;">
 <img class="gallery-img lf-screenshot-carousel-item is-active" data-category="assets" data-name="detail-measures" data-title="📏 Pannello aperto (senza misure)" alt="Pannello Misure Dettaglio Asset">
...
Grafico a torta della distribuzione settoriale e mappa mondiale dell'allocazione geografica per gli asset con metadati ricchi.
...
Editor di dati inline per visualizzare e modificare i singoli punti dati del prezzo.
...
Crea un nuovo asset con nome, tipo, valuta, identificativi, provider e classificazione. Quando attivato dall'Import Wizard, il modulo si apre precompilato con ticker, ISIN e nome estratti.
...
<div class="lf-screenshot-carousel" data-carousel="carousel-desktop-8" data-carousel-interval="6000" data-show-titles="true" style="margin: 1rem 0 2rem 0;">
 ...
 <img class="gallery-img lf-screenshot-carousel-item" loading="lazy" data-category="assets" data-name="create-wizard-modal" data-title="🧙 Dall'Import Wizard (precompilato)" alt="Crea Asset da Import Wizard">
</div>
...
Sincronizza tutte le coppie configurate dai rispettivi provider con monitoraggio dei progressi.
...
Grafico interattivo a dimensione intera per una coppia di valute con interruttore linea/candele.
...
Pannello segnali di indicatori tecnici (EMA, MACD, RSI, Bollinger) sovrapposto al grafico.

<div class="screenshot-container">
 <img class="gallery-img" data-category="fx" data-name="detail-signals" alt="Overlay Segnali di Dettaglio">
</div>
...
<div class="screenshot-container">
 <img class="gallery-img" data-category="fx" data-name="detail-measures" alt="Pannello Misure di Dettaglio">
</div>

### ✏️ Editor Dati

Editor di dati inline per visualizzare e modificare i singoli valori del tasso.
...
Modale per l'importazione di dati dei tassi da file CSV con anteprima e validazione.
