...
hide:
 - navigation
 - toc
description: Libre de comprendre, libre d'agir. LibreFolio réunit tous vos investissements dans un tableau de bord privé et sécurisé avec des outils d'analyse puissants.
---
...
<div class="premium-landing">
 ...
 <h2>Libre de comprendre,<span class="desktop-space"> </span><span class="mobile-break"></span>libre d'agir.</h2>
 ...
 Tout est clair, tout est sous contrôle — car les bonnes décisions commencent par de bonnes informations.
 </p>
 ...
 <p>Le chemin standard pour exécuter LibreFolio en toute confidentialité et fiabilité.</p>
 </div>
 ...
 <p>Suivez notre progression et soyez notifié des nouvelles fonctionnalités :</p>
 ...
 <li>Sélectionnez <strong>Custom</strong> dans le menu déroulant des notifications.</li>
 <li>Cochez <strong>Releases</strong>, puis cliquez sur <strong>Apply</strong>.</li>
 </ul>
 </div>
 ...
 <p>Une vue unifiée de l'ensemble de votre portefeuille. Suivez votre valeur nette, votre allocation et les variations quotidiennes en un seul endroit sécurisé.</p>
 </div>
 ...
 <p>Importez les données <b>directement</b> depuis les fichiers de rapport de votre courtier grâce à des plugins dédiés.</p>
 </div>
 <div class="deep-dive-image">
 <div class="screenshot-container">
 ...
 <div class="deep-dive-content">
 <h2>Transactions</h2>
 <p>Transparence totale sur chaque mouvement. Filtrez, recherchez et modifiez les transactions sur tous vos portefeuilles sans effort.</p>
 </div>
 <div class="deep-dive-image">
 <div class="screenshot-container">
 ...
 <p>Révélez les tendances du marché avec précision. Analyse technique puissante, signaux de trading et indicateurs de performance historique pour chaque actif de votre portefeuille.</p>
 </div>
 <div class="deep-dive-image">
 ...
 data-category="assets" data-name="detail-chart" alt="Graphique de base des détails d'actif">
 <img class="gallery-img lf-screenshot-carousel-item" loading="lazy"
 data-category="assets" data-name="detail-signals-macd" alt="Signaux MACD des détails d'actif">
 <img class="gallery-img lf-screenshot-carousel-item" loading="lazy"
 data-category="assets" data-name="detail-signals-rsi" alt="Signaux RSI des détails d'actif">
 <img class="gallery-img lf-screenshot-carousel-item" loading="lazy"
 data-category="assets" data-name="detail-signals-bollinger" alt="Bandes de Bollinger des détails d'actif">
 </div>
 </div>
 <div class="deep-dive-actions">
 ...
 <div class="deep-dive">
 <div class="deep-dive-content">
 <h2>Actifs et Forex</h2>
 <p>Suivez automatiquement les valorisations des actifs et les taux de change. Gérez des portefeuilles multi-devises avec des données en temps réel provenant directement des fournisseurs financiers et des banques centrales.</p>
 </div>
 <div class="deep-dive-image">
 ...
 <img class="gallery-img lf-screenshot-carousel-item" loading="lazy"
 data-category="assets" data-name="list" data-title="Grille des actifs" alt="Grille des actifs">
 <img class="gallery-img lf-screenshot-carousel-item" loading="lazy"
 data-category="assets" data-name="list-table" data-title="Tableau des actifs" alt="Tableau des actifs">
 </div>
 </div>
 <div class="deep-dive-actions">
 ...
 <a href="user/fx/" class="lf-btn-primary" style="display: inline-flex; align-items: center; gap: 0.5rem;">Gestion du Forex &rarr;</a>
 </div>
 </div>
 ...
 Libérez-vous des feuilles de calcul. LibreFolio est conçu pour <b>se connecter en toute transparence</b> aux outils financiers que vous utilisez déjà, étendant ses capacités grâce à un écosystème croissant de <b>plugins pilotés par la communauté</b>.
 </p>
 ...
 <h4>Importations de courtiers</h4>
 <p><b>Téléversez et traitez</b> vos fichiers d'export de courtier <b>en quelques secondes</b> grâce à des analyseurs intelligents issus de la communauté.</p>
 </div>
 </a>
 </div>
 </div>
 ...
 <div class="provider-info">
 <h4>Cours et cotations des actifs</h4>
 <p><b>Mettez à jour automatiquement</b> les valeurs des actions, ETF et crypto en vous connectant à des fournisseurs de données en temps réel.</p>
 </div>
 </a>
 </div>
 </div>
 ...
 <div class="provider-info">
 <h4>Taux de change et Forex</h4>
 <p><b>Synchronisez les taux de change</b> (FX) pour calculer et équilibrer précisément vos <b>portefeuilles multi-devises</b>.</p>
 </div>
 </a>
 </div>
 </div>
 ...
 <div class="provider-info">
 <h4>Plugins de signaux techniques</h4>
 <p><b>Ajoutez de nouveaux indicateurs</b> sous forme de plugins Python isolés avec paramètres, sorties, seuils et documentation pilotés par schéma.</p>
 </div>
 </a>
 </div>
 </div>
 ...
 <p>LibreFolio aide les investisseurs à long terme à réunir tous leurs portefeuilles dans un espace de travail privé, structuré et prêt pour l'analyse.</p>
 </div>
 ...
 <div class="lf-fit-heading-content">
 <h3><strong>Mieux servi par des produits dédiés</strong></h3>
 ...
 <h4>Espace de travail complet pour portefeuille</h4>
 ...
 <p>Si vous avez seulement besoin d'une simple liste de vos positions, un outil de suivi léger peut suffire.</p>
 </div>
 </div>
 </article>
 </div>
 ...
 <div class="lf-fit-cell-content">
 <h4>Aperçu du solde de base</h4>
 <p>Si vous avez seulement besoin des valeurs actuelles et des totaux, un tableau de bord plus simple peut suffire.</p>
 </div>
 </div>
 </article>
 </div>
 ...
 <p>Un code 100 % libre et consultable vous donne un contrôle absolu sur vos données financières, avec la certitude qu'aucune porte dérobée n'existe.</p>
 </div>
 </div>
 </article>
 <div class="lf-fit-axis">Confidentialité et propriété</div>
 <article class="lf-fit-cell lf-fit-cell-secondary" aria-label="Contexte alternatif">
 <div class="lf-fit-mobile-badge lf-fit-mobile-badge-secondary">
 <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 17l9.2-9.2M17 17V7H7"/></svg>
 Outils spécialisés
 ...
 <p>Si vous préférez vous fier aux promesses de sécurité inscrites dans les conditions d'utilisation d'entreprises privées sans pouvoir les vérifier.</p>
 </div>
 </div>
 </article>
 </div>
 ...
 <p>Concentrez-vous sur la structure, la performance, l'allocation et des décisions éclairées sur la durée.</p>
 </div>
 </div>
 </article>
 ...
 <p>Ajoutez des courtiers, des fournisseurs, des devises et des flux de travail à mesure que le projet évolue.</p>
 </div>
 </div>
 </article>
 ...
 <div class="lf-fit-cell-content">
 <h4>Expérience fermée clé en main</h4>
 <p>Si vous souhaitez un produit fermé sans possibilité de personnalisation, une application plus simple peut mieux convenir.</p>
 </div>
 </div>
 </article>
 </div>
 ...
 <span class="card-desc">Soutenez le projet,<br>FAQ, Crédits et mentions légales.</span>
 </div>
 </a>
