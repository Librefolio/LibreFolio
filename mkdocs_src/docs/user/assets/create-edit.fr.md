...
3. Optionnellement, configurez un **[Fournisseur](providers/index.md)** pour la récupération automatique des prix
4. Optionnellement, ajoutez des distributions **Sectorielles** et **Géographiques**
