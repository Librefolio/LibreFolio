...
LibreFolio admite varios proveedores de precios para obtener automáticamente los precios actuales y los datos históricos de sus activos.
...
<div class="grid cards" style="margin-top: 1.5rem; margin-bottom: 2rem;">
    ...
    <a href="borsa-italiana/" class="card-link" style="flex-direction: column; align-items: stretch; gap: 0.5rem;">
        ...
        <span class="card-desc">Acciones italianas, bonos, ETF y fondos con búsqueda inteligente de URL.</span>
    </a>
    <a href="css-scraper/" class="card-link" style="flex-direction: column; align-items: stretch; gap: 0.5rem;">
        ...
        <span class="card-desc">Scraper de páginas web para precios de bonos personalizados o exóticos.</span>
    </a>
    <a href="scheduled-investment/" class="card-link" style="flex-direction: column; align-items: stretch; gap: 0.5rem;">
        ...
        <span class="card-desc">Activos de renta fija que calculan el valor mediante calendarios de tasas de interés.</span>
    </a>
    <a href="../../../community/contribute/" class="card-link" style="flex-direction: column; align-items: stretch; gap: 0.5rem;">
     ...
     <span class="card-desc">¿Falta su proveedor de precios? ¡Solicite un nuevo plugin o contribuya código!</span>
    </a>
</div>
...
| <img src="https://www.justetf.com/android-chrome-144x144.png?v2" width="16" height="16" style="vertical-align: middle; margin-right: 6px; border-radius: 2px;"> **justETF** | ✅ (EUR) | ✅ | ✅ | ISIN (ej., `IE00BK5BQT80`) | ETF europeos, multimoneda |
| <img src="https://www.borsaitaliana.it/media-rwd/assets/images/favicon.ico" width="16" height="16" style="vertical-align: middle; margin-right: 6px; border-radius: 2px;"> **Borsa Italiana** | ✅ | ✅ | ✅ | ISIN; los fondos usan código interno | Acciones italianas, bonos, ETF y fondos. |
| <img src="../../../static/cssscraper.png" width="16" height="16" style="vertical-align: middle; margin-right: 6px; border-radius: 2px;"> **CSS Scraper** | ✅ | ❌ | ❌ | URL | Extrae datos de precios de cualquier página web |
...
- **Acciones y ETF**: Use **Yahoo Finance** — cobertura más amplia, admite búsqueda
- **ETF Europeos**: Use **justETF** para obtener datos de ETF europeos más detallados
- **Borsa Italiana**: Use Borsa Italiana directamente para acciones, bonos, ETF y fondos de Euronext Milano. La Búsqueda Inteligente también puede resolver URL de Borsa y capturar parámetros automáticamente.
- **Cuentas de ahorro / Depósitos fijos**: Use **Inversión Programada** con calendarios de tasas de interés
