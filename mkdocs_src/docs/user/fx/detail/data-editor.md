...
- **Source** — Where the data came from (provider name, CSV import, or manual)
...
- `date;EUR>USD` means: **1 EUR = X USD** (rates are EUR→USD)
- `date;USD>EUR` means: **1 USD = X EUR** (rates are USD→EUR)
...
- **Left currency** → **Right currency**: the rate tells you how much of the right currency you get for 1 unit of the left currency
