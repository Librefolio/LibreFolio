...
3. Fill in the broker details:
    - **Name**: A descriptive name (e.g., "My Degiro Account")
    - **Base Currency**: The currency of the account (e.g., EUR, USD)
    - **Icon** *(optional)*: Upload a broker logo or avatar
...
Once created, you can click on a broker to see its details, import reports, and manage transactions.
...
- **[Customize settings](../admin/settings.md)** — Adjust language, theme, and system preferences
